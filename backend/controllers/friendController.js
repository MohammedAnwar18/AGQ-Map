...
const cancelFriendRequest = async (req, res) => {
    try {
        ...
        await pool.query('DELETE FROM friend_requests WHERE sender_id = $1 AND receiver_id = $2', [req.user.userId, receiverId]);
...
const rejectBySender = async (req, res) => {
    try {
        const { senderId } = req.params;
        await pool.query('DELETE FROM friend_requests WHERE sender_id = $1 AND receiver_id = $2', [senderId, req.user.userId]);
