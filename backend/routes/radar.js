...
router.get('/intel', async (req, res) => {
    res.json({
        ...
        incidents: [
            ...
            { type: "عبوة ناسفة", city: "طولكرم - الضفة", text: "استهداف آلية عسكرية بعبوة شديدة الانفجار في طولكرم ولا إصابات معلنة حتى الآن.", lat: 32.3086, lon: 35.0285, time: new Date(Date.now() - 150000).toISOString() },
