    ...
    const content = {
        terms: {
            ...
            sections: [
                ...
                {
                    header: "3. السلوك المقبول",
                    body: "أنت مسؤول عن جميع المحتويات التي تنشرها. يمنع منعاً باتاً نشر محتوى يحرض على الكراهية، العنف، أو أي نشاط غير قانوني. يحق لنا تعليق أو حذف أي حساب يخالف هذه المعايير."
                },
                {
                    header: "4. بيانات الموقع",
        ...
        privacy: {
            ...
            sections: [
                ...
                {
                    header: "4. حماية البيانات",
                    body: "نستخدم تقنيات تشفير حديثة (SSL/TLS) لحماية بياناتك أثناء انتقالها، ونقوم بتخزينها في قواعد بيانات مؤمنة بشكل صارم عبر تقنيات PostGIS و Supabase."
                },
                {
                    header: "5. حقوقك",
