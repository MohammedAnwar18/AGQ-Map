...
const MedicalCenterProfileModal = ({ shop, onClose, currentUser, onFollowChange, userLocation }) => {
    ...
    const ALL_SECTIONS = [
        { key: 'products', label: 'العيادات والخدمات الطبية' },
        { key: 'timeline', label: 'الأخبار والمنشورات' },
        { key: 'about', label: 'حول المركز' },
                        ...
                        <div style={{ position: 'absolute', bottom: -50, right: 30 }}>
                            <div style={{ position: 'relative' }}>
                                <div style={{
                                    ...
                                    background: profileUrl ? `url(${profileUrl}) center/cover` : '#ef4444',
...
export default MedicalCenterProfileModal;
